...
<div class="container flex-grow-1 mt-4">
    ...
    <!-- Поиск -->
    <form class="d-flex mb-4" action="${pageContext.request.contextPath}/manufacturer/findAll" method="get">
    ...
    <table class="table table-striped">
        ...
        <c:forEach var="manufacturer" items="${manufacturers}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/manufacturer/edit/${manufacturer.id}"
                       class="btn btn-outline-dark btn-sm me-2">РЕДАКТИРОВАТЬ</a>
                    <a href="${pageContext.request.contextPath}/manufacturer/delete/${manufacturer.id}"
