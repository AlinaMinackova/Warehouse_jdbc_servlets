...
<div class="container flex-grow-1 mt-4">
    <h2 class="text-center mb-4">РЕДАКТИРОВАТЬ СКЛАД</h2>

    <div class="form-container">
        <meta charset="UTF-8">
        <form action="${pageContext.request.contextPath}/warehouse/edit/${warehouse.id}" method="post" accept-charset="UTF-8">
