        ...
        if (path != null) {
            ...
            if (parts.length > 1) {
                try {
                    ...
                    req.getRequestDispatcher("/product/product_edit.jsp").forward(req, resp);
            ...
            if (parts.length > 1) {
                try {
                    ...
                    try {
                        ...
                        Product product = new Product(id, name, manufacturer, category, fileName, lifeDays, weight, composition);

                        productService.update(product, fileName);
